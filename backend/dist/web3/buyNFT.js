...
export const buyNFT = async (tokenId, priceInXLM) => {
    try {
        ...
        const tx = new TransactionBuilder(sourceAccount, {
            ...
            .addOperation(contract.call("instant_settle", nativeToScVal(accountKP.publicKey(), { type: "address" }), nativeToScVal(accountKP.publicKey(), { type: "address" }), nativeToScVal(Number(priceInXLM) * 1e7, { type: "i128" }), nativeToScVal(accountKP.publicKey(), { type: "address" })))
            .setTimeout(30)
            .build();
