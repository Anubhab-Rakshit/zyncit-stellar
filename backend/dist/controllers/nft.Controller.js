 ...
 * @access  Private
 */
export const myNFTs = asyncHandler(async (req, res) => {
 ...
 * @access  Private
 */
export const setNFTPrice = asyncHandler(async (req, res) => {
    const userAddress = req.user.address;
 ...
 * @access  Private
 */
export const toggleNFTSale = asyncHandler(async (req, res) => {
    const userAddress = req.user.address;
    const { tokenId } = req.params;
